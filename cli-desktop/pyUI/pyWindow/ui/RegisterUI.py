...
class Ui_RegisterWd(object):
    def setupUi(self, RegisterWd):
        ...
        self.RestButton = QtWidgets.QCommandLinkButton(RegisterWd)
        self.RestButton.setGeometry(QtCore.QRect(360, 465, 111, 31))
        font = QtGui.QFont()
        ...
        self.RestButton.setAutoRepeatInterval(97)
        ...
        self.EmaiLlabel.setGeometry(QtCore.QRect(-1, 55, 81, 40))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
